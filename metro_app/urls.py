...
urlpatterns = [
    ...
    path(r'<simulation_id>[0-9]+/pricing/',
        views.pricing_main, name='pricing_main'),
    path(r'<simulation_id>[0-9]+/pricing/view/',
        views.pricing_view, name='pricing_view'),
    # path(r'<simulation_id>[0-9]+/pricing/edit/',
        # views.pricing_edit, name='pricing_edit'),
    path(r'<simulation_id>[0-9]+/pricing/save/',
        views.pricing_save, name='pricing_save'),
    path(r'<simulation_id>[0-9]+/pricing/export/',
        views.pricing_export, name='pricing_export'),
    path(r'<simulation_id>[0-9]+/pricing/import/',
        views.pricing_import, name='pricing_import'),
    path(r'<simulation_id>[0-9]+/pricing/reset/',
