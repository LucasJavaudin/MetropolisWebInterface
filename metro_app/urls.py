...
urlpatterns = [
    ...
    path(r'<simulation_id>/demand/import', views.usertype_import,
         name='usertype_import'),
    ...
    # Environment pages.
    path(r'environments', views.environments_view, name='environments_view'),
    path(r'environments/create', views.environment_create,
         name='environments_create'),
    path(r'environments/add_view/<environment>', views.environment_add_view,
         name='environments_add_view'),
    path(r'environments/add/<environment>', views.environment_add,
         name='environments_add'),
    path(r'environments/<environment>/<user>', views.environment_user_delete,
